                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableSmllTitle">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="top" style="padding-bottom:10px;" class="smllTitle">
                                                                    ...
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        Hello Mr/Mrs, <span style="font-weight: 500">{{ $datas->name }}</span>,
                                                                        <br>
                                                                        Welcome to YKK Zipper Indonesia ! You now have access to Visitor Management System related to Smart Office Ykk Zipper Indonesia application.
                                                                        <br><br>
                                                                        To access Smart Office:
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" valign="top" style="padding-bottom:20px;" class="smllSubTitle">
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        Your username: <span style="font-weight: 500;">{{ $datas->email }}</span>

                                                                    </p>
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        Your password: <span style="font-weight: 500;">{{ $randPass }}</span>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" style="padding-bottom:20px;" class="smllSubTitle">
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        We suggest to change your password in My Profile Menu ofter logging in.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" valign="top" style="padding-bottom:20px;" class="smllSubTitle">
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        If you have an inquiry or need assistance, visit the contact page on our website or admin GA.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
