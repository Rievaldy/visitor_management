...
class NDAController extends Controller
{
    ...
    {
        return view('NDA.index');

    }



    public function getAllNDA(Request $request){
        ...
        foreach($projects as $project){
            ...
            $data_arr[] = array(
                ...
                "location_strictly" => $location_strictly,
                "findings"=>"-"
            );
        }
        $response = array(
    ...
    public function getProjectDetail(Request $request){
        ...
        return view('NDA.detail-project', compact('project','employee_PIC', 'employee_to_meet','visitor_PIC','visitor_member','location_meet', 'location_strictly', 'location_restricted'));
    }

    public function ndaApproveProject($id)
    {
        Project::where('id', $id)->update(array('status' => 4));
