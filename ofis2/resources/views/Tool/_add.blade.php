...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Add New Tools</h3>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box">
                ...
                <form action="{{ route('toolStore') }}" method="POST" enctype="multipart/form-data" >
                @csrf
                    <div class="box-body">
                        @if(session('errors'))
                        ...
                        <div class="form-group">
                            <label>Tools Photo<span class="text-danger">*</span></label>
