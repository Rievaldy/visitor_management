        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header">
                    <h4 class="box-title">Meeting Participant Report</h4>
                </div>
                <div class="box-body">
                    <div class="table-responsive">
                        ...
                        <table class="table" id="dataTable">
                            <thead>
                                <tr class="">
                                    {{-- <th class="">#</th> --}}
                                    <th class="text-nowrap">Meeting Date</th>
                                    <th class="text-nowrap">Room Name</th>
                                    <th class="text-nowrap">Meeting Start</th>
                                    <th class="text-nowrap">Meeting End</th>
                                    <th class="text-nowrap">Participant Name</th>
                                    <th class="text-nowrap">Participant Email</th>
                                    <th class="text-nowrap">Participant Company</th>
                                    <th class="text-nowrap">Participant Phone</th>
                                    <th class="text-nowrap">Status</th>
                                    <th class="text-nowrap">Present At</th>
                                </tr>
                            </thead>
                            <tbody>
                                {{-- @php
                                ...
                                @foreach ($datas as $data)
                                    <tr class="">
                                        ...
                                        <td class="text-nowrap">
                                            @if ($data->present_at != null)
                                                {{ date('H:i:s', strtotime($data->present_at))}}
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                ...
                buttons: [
                    {
                        ...
                        title: 'Meeting Participant Report'
                    },
                ],
            });
