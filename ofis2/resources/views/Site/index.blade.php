...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Sites</h3>
    </div>
@endsection
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-6 text-left">
                            <h4 class="box-title">Sites List</h4>
                        </div>
                        <div class="col-6 text-right">
                            <a href="{{ route('siteAdd') }}" class="btn btn-bold btn-pure btn-info">Add</a>
                        </div>
                    </div>
                </div>
                <div class="box-body">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">View Site</h4>
                                </div>
                                ...
                                @csrf
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea rows="4" name="address" cols="4" class="form-control" readonly></textarea>
                                        </div>
                                    </div>
        ...
        $('#data-tables').on('click', 'button.btn-view', function () {
            ...
            $.ajax({
                ...
                success: function(item) {
                    ...
                    $('#modal-detail').find('textarea[name=address]').val(item.address)
                    // console.log(item.id)
                    $('#modal-detail').find('form').attr('action','/sites/edit/'+item.id)
