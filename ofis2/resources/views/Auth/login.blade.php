                ...
                <div class="col-12">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-3 col-md-5 col-12 xtd">
                            <h2 class="text-center">Welcome to VMS <br>YKK Zipper Indonesia</h2>
                            <div class="p-30 content-bottom rounded bg-img box-shadowed" style="background: rgba(255, 255, 255, .7)">
                                ...
                                <div class="pt-4">
                                    {{-- <h4 class="text-dark font-size-30">Get Started<br>with your Dashboard</h4> --}}
                                    <h5 class="text-dark mb-0">need support? <a href="mailto:vms@ykk.co.id?subject=Need support smart office" class="text-info">vms@ykk.co.id</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
