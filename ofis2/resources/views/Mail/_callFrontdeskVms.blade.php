                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="padding-bottom:5px;padding-left:20px;padding-right:20px; padding-top: 30px; padding-bottom: 30px" class="mainTitle">
                                                    ...
                                                    <h2 class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:28px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:36px; text-transform:none; text-align:center; padding:0; margin:0">
                                                        Please come to VMS immediately
                                                    </h2>
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" style="padding-bottom:10px;" class="smllTitle">
                                                                    ...
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        ...
                                                                        <br>
                                                                        Please come to VMS immediately, there are visitors who need your help at VMS.
                                                                        <br>
                                                                        <br>
                                                                        <em>Harap segera datang ke VMS, ada visitor yang membutuhkan bantuan Anda di vms.</em>
                                                                        <br>
                                                                        <br>
                                                                        Thanks,
                                                                        <br><br>
