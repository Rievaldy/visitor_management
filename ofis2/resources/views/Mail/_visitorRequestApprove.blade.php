                                                ...
                                                <tr>
                                                    <td align="center" valign="top" style="padding-left:20px;padding-right:20px;" class="containtTable ui-sortable">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableSmllTitle">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom:2rem;" class="smllTitle">
                                                                        <!-- Small Title Text // -->
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:18px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                            Hi <span style="text-transform: capitalize">{{ $data->vname }}</span>, <br>
                                                                            We are happy to inform you that your visit request has been approved.
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom:20px;" class="smllSubTitle">
                                                                        ...
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:18px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:26px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                            {{ date('H:i:s', strtotime($data->time_start)) }} - {{ date('H:i:s', strtotime($data->time_end)) }}
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-top:20px;padding-bottom:40px;">
                                                                        @php
                                                                            ...
                                                                            $pad = str_pad( $data->id_company, 4, "0", STR_PAD_LEFT );
                                                                            $qr = $ucode . '-' . $pad . '-' . $data->idvis;
                                                                        @endphp
                                                                        <img src="{!!$message->embedData(QrCode::format('png')->size(512)->margin(1)->generate($qr), 'QrCode.png', 'image/png')!!}" alt="" style="width: 225px">
                                                                        <p style="text-center">{{ $qr }}</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
