        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header">
                    <h4 class="box-title">Locker Log Report</h4>
                </div>
                <div class="box-body">
                            ...
                            <table class="table" id="dataTable">
                                <thead>
                                    <tr class="">
                                        ...
                                        <th class="text-nowrap">Locker Code</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $data)
                                        <tr class="">
                                            ...
                                            <td class="text-nowrap">{{ $data->empl_id }}</td>
                                            <td class="text-nowrap">{{ $data->empl_name }}</td>
                                            <td class="text-nowrap">{{ $data->locker_name }}</td>
