        ...
        <div class="col-12">
            <div class="box">
                <div class="box-header">
                    <h4 class="box-title">Attendance Offline Report</h4>
                </div>
                <div class="box-body">
                    <div class="table-responsive">
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-6">
                                {{-- <input type="text" class="form-control" id="max" name="max" value="{{ date('F d Y') }}"></td> --}}
                                <div class="form-group mb-0">
                                    <label for="">To</label>
                            ...
                            <table class="table" id="dataTable">
                                <thead>
                                    <tr class="">
                                        ...
                                        <th class="text-nowrap">FAC No.</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $data)
                                        <tr class="">
                                            ...
                                            <td class="text-nowrap">{{ $data->fac_checkin }}</td>
                                            <td class="text-nowrap">{{ $data->checkout }}</td>
                                            <td class="text-nowrap">{{ $data->fac_checkout }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
            ...
            buttons: [
                {
                    ...
                    title: 'Attendance Offline Report'
                },
            ],
            // order: [[ 0, "desc" ]]
        });
