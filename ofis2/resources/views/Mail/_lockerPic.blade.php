                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom:10px;" class="smllTitle">
                                                                        ...
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                            Dear Mr/Mrs {{ $data[0]->pic_name }},
                                                                        </p>
                                                                        <br>
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                            {{ $data[0]->name }} asks for your help to open the locker {{ $data[0]->id_locker }} by the @if ($data[0]->method != null)
                                                                                @if ($data[0]->method == 1)
                                                                                ID Face Recognition
                                                                                @endif
                                                                            @endif method for requirements @if ($data[0]->necessity != null)
                                                                                @if ($data[0]->necessity == 1)
                                                                                    Document
                                                                                @elseif ($data[0]->necessity == 2)
                                                                                    Stationary
                                                                                @elseif ($data[0]->necessity == 3)
                                                                                    Apparel
                                                                                @elseif ($data[0]->necessity == 4)
                                                                                    Other
                                                                                @endif
                                                                            @endif
                                                                        </p><br>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom: 10px;">
                                                                        <p class="text" style="color: #333333; font-family:'Poppins',sans-serif; font-size:16px; font-weight:500px; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                            After receiving this email confirmation, the time limit for using locker access is 30 minutes.
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-top:10px;padding-bottom:5px;padding-left:10px;padding-right:10px;" class="brandInfo">
                                        <!-- Brand Information // -->
                                        <p class="text" style="color:#777777; font-family: 'Poppins', sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">©&nbsp;MRT Jakarta. | Wisma Nusantara, M.H. Thamrin Street No.59 | DKI Jakarta, 10350, Indonesia.
                                        </p>
                                    </td>
                                </tr>
