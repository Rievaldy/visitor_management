...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Edit Site</h3>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box">
                ...
                <form action="{{ url('sites/update/'.$site->id) }}" method="POST">
                @csrf
                    <div class="box-body">
                        @if(session('errors'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="address" cols="4" class="form-control" placeholder="">{{$site->address}}</textarea>
                        </div>
                    </div>
