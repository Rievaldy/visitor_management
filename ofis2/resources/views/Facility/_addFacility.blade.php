...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Add New Property</h3>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box">
                ...
                <form action="{{ route('facilitiesStore') }}" method="POST">
                @csrf
                    <div class="box-body">
                        @if(session('errors'))
                        ...
                        <div class="form-group">
                            ...
                            <input name="code" type="text" class="form-control" value="" placeholder="">
                        </div>
                        <div class="form-group">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input name="code_asset" type="text" class="form-control" value="" placeholder="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc" rows="4" cols="4" class="form-control" placeholder=""></textarea>
                        </div>
                        <div class="form-group">
