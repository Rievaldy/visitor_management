...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Tools</h3>
    </div>
@endsection
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-6 text-left">
                            <h4 class="box-title">Tools List</h4>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">View Tool</h4>
                                </div>
        ...
        $('#data-tables').on('click', 'button.btn-view', function () {
            ...
            $.ajax({
                ...
                success: function(item) {
                    $('#modal-detail').find('#imgTool').attr('src',item.img);
