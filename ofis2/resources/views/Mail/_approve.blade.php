...
{{--                                                                            Dear Mr/Mrs {{ $emailTo->name }},--}}
                                                                            Dear Mr/Mrs
                                                                            <br>
{{--                                                                        You were invited to a meeting by {{ $pic[0]->pic_name }}.--}}
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom:20px;" class="smllSubTitle">
                                                                        <p class="text" style="color:#777777; font-family: 'Poppins', sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:26px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                            MEETING TITLE
                                                                        </p>
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:18px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:26px; text-transform:none; text-align:left; padding:0; margin:0">
{{--                                                                            {{ $books->desc }}--}}
                                                                        </p>
                                                                    </td>
                                                                </tr>
...
{{--                                                                            {{ date('M d, Y', strtotime($books->meeting_date)) }}--}}
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom:20px;" class="smllSubTitle">
                                                                        ...
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:18px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:26px; text-transform:none; text-align:left; padding:0; margin:0">
{{--                                                                            {{ date('H:i', strtotime($books->h_start)) }} - {{ date('H:i', strtotime($books->h_end)) }}--}}
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom:20px;" class="description">
                                                                        ...
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
                                                                            QR Code is used as access to enter the Office and Meeting Room
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" style="padding-bottom:40px;" class="infoDate">
                                                                        ...
                                                                        <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:11px; font-weight:700; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0">
                                                                            Notes: This invitation applies to Personal Not Institutions.
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
