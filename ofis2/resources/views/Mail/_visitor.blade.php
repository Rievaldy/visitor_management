...
<body>
    <p>Dear Mr./Mrs. {{ $getPic[0]->name }}</p>
    <p>There were guests present:</p>
    <p style="text-transform: capitalize">Name : <b>{{ $guestName }}</b></p>
    <p style="text-transform: capitalize">Necessity: <b>{{ $guestNecessity }}</b></p>
    <p style="text-transform: capitalize">Company: <b>{{ $guestCompany }}</b></p>
    <p>Please meet at the Lobby!</p>
    <p>Regards,</p>
    <p>Smart Office Team</p>
</body>
</html> --}}
...
<html lang="en">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,300;0,300;0,300;0,300;0,600;0,700;0,800;0,900;1,100;1,300;1,300;1,300;1,300;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
    </head>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="middle" style="padding-top: 20px; padding-bottom: 10px;" class="emailLogo">
                                                                    ...
                                                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/MRT_Jakarta_logo.svg/2560px-MRT_Jakarta_logo.svg.png" alt="" width="150" border="0" style="width:100%; max-width:300px;height:auto; display:block;">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="padding-bottom:5px;padding-left:20px;padding-right:20px; padding-top: 30px; padding-bottom: 30px" class="mainTitle">
                                                    <!-- Main Title Text // -->
                                                    <h2 class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:28px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:36px; text-transform:none; text-align:center; padding:0; margin:0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="top" style="padding-bottom:10px;" class="smllTitle">
                                                                    <!-- Small Title Text // -->
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        Dear Mr./Mrs. <span style="font-weight: 500">{{ $getPic[0]->name }}</span>,
                                                                        <br>
                                                                        <b>{{ $guestName }}</b> from <b>{{ $guestCompany }}</b> is here to see you for {{ $getPic[0]->name }} at MRT Jakarta Head Office.
                                                                        <br>
                                                                        If you want to meet the guest please go to lobby area or if you want to decline the please tell the receptionist.
                                                                        <br><br>
                                                                    </p>
                                                                </td>
                                                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td align="center" valign="top" style="padding-top:10px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="socialLinks">
                                    ...
                                    <a href="https://www.facebook.com/jakartamrt/" target="_blank" style="display: inline-block;" class="facebook">
                                    ...
                                    <a href="https://twitter.com/mrtjakarta?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" style="display: inline-block;" class="twitter">
                                    ...
                                    <a href="https://www.instagram.com/mrtjkt/?hl=id" target="_blank" style="display: inline-block;" class="instagram">
                                    ...
                                    <a href="https://id.linkedin.com/company/pt.-mrt-jakarta" target="_blank" style="display: inline-block;" class="linkdin">
                            ...
                            <tr>
                                <td align="center" valign="top" style="padding-top:0px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="footerEmailInfo">
                                    ...
                                    <p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                        If you have any quetions please contact us <a href="#" style="color:#777777;text-decoration:underline;" target="_blank">smartoffice@jakartamrt.co.id.</a>
                                    </p>
                                </td>
                            </tr>
                            <!-- Space -->
