...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Edit F&B Category</h3>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box">
                ...
                <form method="POST" action="{{ url('foodandbaverages/categories/update/'.$cats->id) }}">
                @csrf
                    <div class="box-body">
                        @if(session('errors'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $cats->name }}" placeholder="">
                        </div>
                        <div class="form-group">
