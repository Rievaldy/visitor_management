                ...
                <div class="box-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="" class="btn btn-bold btn-pure btn-info pl-4 pr-4" data-toggle="modal" data-target="#exampleModal">Book Now</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header">
                                    <h4 class="box-title">Create New Meeting</h4>
                                </div>
                                <form action="{{ route('addBookNow') }}" method="POST">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-sm-12 col-12">
                                                    <input name="meeting_date" id="datepickerModal" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                            <small>You can only book meeting for up to 30 days ahead</small>
                                        </div>
                                        <div class="form-group">
                                            <label>Meeting time</label>
                                            <div class="row align-items-center">
                                                <div class="col-sm-5 col-5">
                                                    <input name="h_start_dom" type="time" id="currentTime" class="form-control" value="" placeholder="Start time" required>
                                                ...
                                                <div class="col-sm-5 col-5">
                                                    <input name="h_end_dom" type="time" class="form-control" value="" placeholder="End time" required>
                                                    <small>&nbsp;</small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-sm-12 col-12">
                                                    <select name="room_id" id="selectRoom" class="form-control select2" style="width: 100%" required></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
