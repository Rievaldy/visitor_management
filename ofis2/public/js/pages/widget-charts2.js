	...
	new Chart(document.getElementById("bar-chart1"), {
		...
		data: {
		  ...
		  datasets: [
			{
			  label: "Dataset",
			  backgroundColor: ["#17b3a3", "#ff4c52","#0bb2d4","#3e8ef7","#faa700"],
	...
	new Chart(document.getElementById("polar-chart1"), {
		...
		data: {
		  ...
		  datasets: [
			{
			  label: "Dataset",
			  backgroundColor: ["#0bb2d4", "#17b3a3","#3e8ef7","#faa700","#ff4c52"],
