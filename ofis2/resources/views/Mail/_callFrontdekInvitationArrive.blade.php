                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" style="padding-bottom:10px;" class="smllTitle">
                                                                    ...
                                                                    <p class="text" style="color:#333333; font-family: 'Poppins', sans-serif; font-size:16px; font-weight:300; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:left; padding:0; margin:0">
                                                                        Dear Mr./Mrs. <span style="font-weight: 500">{{$emailTo->name}}</span>,
                                                                        <br>
                                                                        Invited guests from <b>{{ $getPic[0]->name }}</b> have arrived. Please invite Mr./Mrs. <b>{{ $guestName }}</b> waited for a while in the Lobby area.
                                                                        <br>
                                                                        <br>
                                                                        <em>Tamu undangan dari <b>{{ $getPic[0]->name }}</b> telah datang. Mohon untuk mempersilahkan Mr./Mrs. <b>{{ $guestName }}</b> menunggu sebentar di Lobby area.</em>
                                                                        <br>
                                                                        <br>
                                                                        Thanks,
                                                                        <br><br>
