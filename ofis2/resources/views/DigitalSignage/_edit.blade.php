...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Add Digital Signage User</h3>
    </div>
@endsection
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header">
                    <h4 class="box-title">Digital Signage Info</h4>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" class="form-control select2">
                                @foreach ( $users as $user )
                                    <option value="{{ $user->id }}" {{$user->id == $user->ds_user_id ? 'disabled' : '' }}>{{ $user->name }}</option>
                                @endforeach
                            </select>
