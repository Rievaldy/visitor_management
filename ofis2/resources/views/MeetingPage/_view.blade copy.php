                ...
                <div class="box-body pt-0 collapse show" id="collapseExample">
                    @if ( $activeBooks != null)
                        <div class="">
                            ...
                            <input type="hidden" class="room_id" id="newh_end" value="{{ date('H:i:0', strtotime($activeBooks[0]->h_end) - (10 * 60)) }}">
                        </div>
                        <div class="row">
                            <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 control-wrapper">
                                                        ...
                                                        <input type="text" value="{{ $door->devices_id }}" name="device_id" readonly class="bg-transparent border-0 form-control text-white pl-0 deviceName">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 control-wrapper">
                                                        ...
                                                        <input type="hidden" name="device_id" readonly class="bg-transparent border-0 form-control text-white pl-0 deviceName">
                                                        <form class="d-inline">
                                                            <div class="float-right">
                                                                <label class="toggle-control">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-12 control-wrapper">
                                                            ...
                                                            <input type="text" value="{{ $control->devices_id }}" name="device_id" readonly class="bg-transparent border-0 form-control text-white pl-0 deviceName">
...
@section('script')
    ...
    <script>
        ...
        function startTime() {
            ...
            if (timeNow == hEnd) {
                alert('meeting akan segera berakhir dalam 10 menit');
            }
