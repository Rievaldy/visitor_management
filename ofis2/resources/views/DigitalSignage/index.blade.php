...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Digital Signage</h3>
    </div>
@endsection
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-6 text-left">
                            <h4 class="box-title">Digital Signage List</h4>
                        </div>
                    </div>
                </div>
                <div class="box-body">
                        ...
                        <table class="table table-striped dataTables">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-left">Camera Type</th>
                                    <th class="text-left text-nowrap">Digital Signage User</th>
                            ...
                            <tbody>
                                ...
                                @foreach ( $rooms as $room )
                                    <tr>
                                        ...
                                        <td class="">
                                            {{ $room->is_ds_mirror === 1 ? "Normal" : "Mirror" }}
                                        </td>
                                        <td class="">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ url('digital-signage/'.$room->room_id) }}" method="GET" class="d-inline">
                                            @csrf
                                            ...
                                            @if ( $room->id_ds != null )
                                                <form action="{{ url('digital-signage/delete/'.$room->id_ds) }}" method="POST" onsubmit="return confirm('Are you sure? This digital signage user and details will be permanantly deleted!')" class="d-inline">
                                                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    <h5 class="modal-title" id="exampleModalLabel">View Digital Signage</h5>
                ...
                <div class="modal-body p-0 border-0">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="box mb-0">
                                <form action="{{ route('storeDigitalSignage') }}" method="POST">
                                @csrf
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_id" class="select2 form-control" style="width: 100%">
                                                <option value="" disabled selected>Select DS User</option>
