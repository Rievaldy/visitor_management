    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                        {{-- <a href="{{ url('/purchasing') }}" class="btn btn-bold btn-pure btn-secondary btn-block">Cancel</a> --}}
                        <a href="javascript:history.back()" class="btn btn-bold btn-pure btn-secondary btn-block">Cancel</a>
                    </div>
                </div>
                @if($project['status'] == 6 && (auth()->user()->usere_type == 2||auth()->user()->usere_type == 99))
                    <div class="col-3">
                        <div class="form-group">
