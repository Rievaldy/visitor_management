...
@section('breadcrumb')
    <div class="mr-auto w-p50">
        <h3 class="page-title border-0">Property Categories</h3>
    </div>
@endsection
            ...
            <div class="flexbox flex-justified text-center mb-30 bg-primary">
                ...
                <div class="py-30 bg-white text-dark">
                    <div class="font-size-30">
                        <?php
                            $count = DB::table('facility_cats')->count();
                            echo $count;
                        ?>
                    </div>
        ...
        <div class="col-12 col-md-6 col-xl-3">
            <div class="flexbox flex-justified text-center mb-30 bg-danger">
                ...
                <div class="py-30 bg-white text-dark">
                    <div class="font-size-30">
                        <?php
                            $total = DB::table('facility_cats')->where('status', 1)->count();
                            echo $total.'/';
                        ?>
                ...
                <div class="box-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <a href="{{ route('facilitiesAddCat') }}" class="btn btn-bold btn-pure btn-info">Add New Category</a>
                        </div>
                    </div>
                </div>
                <div class="box-body">
                                ...
                                @foreach ( $cats as $cat )
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ url('facilities/categories/'.$cat -> id) }}" method="POST" onsubmit="return confirm('Are you sure? This record and its details will be permanantly deleted!')" class="d-inline">
                                                @method('DELETE')
                                                @csrf
...
@section('script')
    <script>
        $('.btn-view').on('click',function(){
            ...
            // console.log(item.id)
            $('#modal-detail').find('form').attr('action','/facilities/categories/edit/'+item.id)
        })
